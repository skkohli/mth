            ...
            if ($sms_otp || $email_otp) {
                ...
                <div class="listeo-register-form-fields-container" data-otp-type="<?php echo esc_attr($otp_type); ?>">
                    ...
                    ?>
                        <div class="account-type">
                            <div>
                                ...
                                <label for="freelancer-radio<?php echo $random; ?>"><i class="sl sl-icon-user"></i> <?php echo esc_html_x('Guest', 'User role', 'listeo_core'); ?></label>
                            </div>
                    ...
                    <?php if (get_option('listeo_display_password_field')) : ?>
                        ...
                        <?php if (get_option('listeo_strong_password')) : ?>
                            <div class="password-strength-requirements">
                                <?php esc_html_e('Password must be at least', 'listeo_core'); ?> <strong class="req-length">8 <?php esc_html_e('characters', 'listeo_core'); ?></strong> <?php esc_html_e('and include:', 'listeo_core'); ?><br>
                                <strong class="req-uppercase"><?php esc_html_e('One uppercase letter', 'listeo_core'); ?></strong>, <strong class="req-number"><?php esc_html_e('one number', 'listeo_core'); ?></strong>, <?php esc_html_e('and', 'listeo_core'); ?> <strong class="req-special"><?php esc_html_e('one special character', 'listeo_core'); ?></strong>
                            </div>
                        <?php endif; ?>
                    <?php endif; ?>
                    ...
                    ?>
                        <p class="form-row margin-top-10 checkboxes margin-bottom-10">
                            <input type="checkbox" id="privacy_policy_<?php echo $random_id; ?>" name="privacy_policy">
                            <label for="privacy_policy_<?php echo $random_id; ?>"><?php esc_html_e('I agree to the', 'listeo_core'); ?> <a target="_blank" href="<?php echo get_privacy_policy_url(); ?>"><?php esc_html_e('Privacy Policy', 'listeo_core'); ?></a> </label>
                    ...
                    if ($terms_and_condition_status) {
                        $random_id = rand(10, 100); ?>
                        <p class="form-row margin-top-10 checkboxes margin-bottom-10">
                            <input type="checkbox" id="terms_and_conditions_<?php echo $random_id; ?>" name="terms_and_conditions">
                            <label for="terms_and_conditions_<?php echo $random_id; ?>"><?php esc_html_e('I agree to the', 'listeo_core'); ?> <a target="_blank" href="<?php echo get_permalink($terms_and_condition_status_page); ?>"><?php esc_html_e('Terms and Conditions', 'listeo_core'); ?></a> </label>
