			...
			<div class="inner">
						...
						<ul class="booking-list">
							<li class="highlighted" id="details">
								...
								if (
									...
									<?php $details_guests_output[] = $details->adults . ' ' . _n('Guest', 'Guests', $details->adults, 'listeo_core') ?>
								<?php endif; ?>
								<?php if (
									isset($details->adults)  && $details->adults > 0 &&
									$has_children == true
								) : ?>
									<?php $details_guests_output[] = $details->adults . ' ' . _n('Adult', 'Adults', $details->adults, 'listeo_core') ?>
								<?php endif; ?>
								<?php if (isset($details->children) && $details->children > 0) : ?>
									<?php $details_guests_output[] = $details->children . ' ' . _n('Child', 'Children', $details->children, 'listeo_core') ?>
								<?php endif; ?>
								<?php if (isset($details->infants) && $details->infants > 0) : ?>
									<?php $details_guests_output[] = $details->infants . ' ' . _n('Infant', 'Infants', $details->infants, 'listeo_core') ?>
								<?php endif; ?>
								<?php if (isset($details->animals) && $details->animals > 0) : ?>
									<?php $details_guests_output[] = $details->animals . ' ' . _n('Animal', 'Animals', $details->animals, 'listeo_core') ?>
								<?php endif; ?>

								<?php if (isset($details->tickets)  && $details->tickets > 0) : ?>
									<?php $details_guests_output[] = $details->tickets . ' ' . _n('Ticket', 'Tickets', $details->tickets, 'listeo_core') ?>
								<?php endif; ?>
				...
				<?php if (isset($details->message) && !empty($details->message)) : ?>
					<div class="inner-booking-list">
						...
						<?php echo wpautop(esc_html(Listeo_Core_Messages::filter_contact_info(stripslashes($details->message)))); ?>
					</div>
				<?php endif; ?>
