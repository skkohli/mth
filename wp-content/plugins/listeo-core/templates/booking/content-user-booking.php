...
<div class="booking-card <?php echo esc_attr($status_config['border'] ?? ''); ?>" id="booking-list-<?php echo esc_attr($data->ID); ?>">
    ...
    <div class="booking-content-grid">
        <div class="booking-content-grid-details">
                        ...
                        ?>
                            <div class="booking-date">
                                ...
                                <span class="booking-date-value">
                                    <?php
                                    /**
                                     * Filter the event date HTML shown on the My Bookings card.
                                     *
                                     * Booking Plus uses this to display the actual booked
                                     * occurrence date instead of the listing's anchor _event_date.
                                     *
                                    ...
                                    if ( ! empty( $bp_event_date ) ) {
                                        ...
                                        if ( $booked_ts ) {
                                            ...
                                            // that may not have date_start set.
            ...
            <?php
            /**
             * Hook: listeo_booking_card_after_date
             *
             * Allows plugins to inject additional sections after the date section.
             *
             * @param object $data    Booking data row.
             * @param object $details Decoded comment JSON.
             * @param array  $svg_icons SVG icon strings.
             */
    ...
    <div class="booking-card-footer">
        ...
        <div class="booking-actions">
            ...
            if (isset($payment_url) && !empty($payment_url) && !get_option('listeo_disable_payments') && $_payment_option != 'pay_cash'): ?>
                ...
                <?php endif; ?>
            <?php endif; ?>
            <?php if (isset($zoom_join_url) && !empty($zoom_join_url)): ?>
                <div class="booking-detail-item">
                    <a href="<?php echo esc_url($zoom_join_url); ?>" target="_blank" class="booking-btn booking-zoom-btn booking-btn-primary">
                        <?php echo $svg_icons['video']; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped 
                        ?>
                        <?php esc_html_e('Join Zoom', 'listeo_core'); ?>
                    </a>
                </div>
            <?php endif; ?>
