...
(function ( $ ) {
    ...
    $(function () {
        ...
        if(listeo_core.address_provider == 'google'){
            ...
            // Check if location_search input exists (works on both homepage and search results page)
            ...
            if (input) {
              ...
              // Only move PAC container on homepage (where .main-search-input-item exists)
              if ($('.main-search-input-item').length) {
