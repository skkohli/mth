...
class Field {
	...
	/**
	 * Storage for dynamic properties to prevent PHP 8.2+ deprecation warnings.
	 *
	 * @access private
	 * @var array
	 */
	 ...
	 * This prevents PHP 8.2+ deprecation warnings while maintaining backward compatibility.
	 *
	...
	public function __set( $name, $value ) {
		...
		if ( property_exists( $this, $name ) ) {
			...
			// Store unknown properties in our dynamic properties array
	...
	public function __get( $name ) {
		...
		return isset( $this->dynamic_properties[ $name ] ) ? $this->dynamic_properties[ $name ] : null;
	}
	...
	public function __isset( $name ) {
		return property_exists( $this, $name ) || isset( $this->dynamic_properties[ $name ] );
	}
