...
.lbp-resources-badge.no-resources,
.lbp-ms-state-selected, .lbp-ms-state-selected:hover,
...
$rgb_values = sscanf($homecolor, "#%02x%02x%02x");
$homecolor_rgb = is_array($rgb_values) ? implode(",", $rgb_values) : '51,51,51';
